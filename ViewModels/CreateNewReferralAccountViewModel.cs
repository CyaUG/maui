...
{
    internal class CreateNewReferralAccountViewModel : BaseViewModel, ICreateNewReferralAccountViewModel
    {
        ...
        public CreateNewReferralAccountViewModel()
        {
        ...
        async Task ExecureCreateReferralProfileCommand()
        {
            try
            {
                ...
                if (goOn)
                {
                    ...
                    MessagingCenter.Send<CreateNewReferralAccountViewModel, bool>(this, "isSeekerRunning", true);
                    await ReferralAccount.submitReferralAccount(referralAccount, NationalID, ProfilePicture);
                    GoBack();
                }
                else
                {
                    MessagingCenter.Send<CreateNewReferralAccountViewModel, string>(this, "message", "Provide all the details to apply");
                }
            }
            catch (Exception e)
            {
