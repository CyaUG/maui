...
namespace Youth.Models
{
    public class ReferralDistrict
    {
        ...
        public static async Task<JObject> fetchAllReferralDistricts()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage response = await client.GetAsync(Constants.API_GET_ALL_DISTRICTS);
