...
namespace Youth.Views.Shopping
{
    ...
    public partial class ShoppingCategoriesPage : ContentPage
    {
        IShoppingCategoriesViewModel _viewModel;
        public ShoppingCategoriesPage(IShoppingCategoriesViewModel viewModel)
        {
            InitializeComponent();
