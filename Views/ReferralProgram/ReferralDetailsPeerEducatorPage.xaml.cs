...
namespace Youth.Views.ReferralProgram
{
    ...
    public partial class ReferralDetailsPeerEducatorPage : ContentPage
    {
        IReferralDetailsViewModel _viewModel;
        public ReferralDetailsPeerEducatorPage(IReferralDetailsViewModel viewModel)
        {
            InitializeComponent();
            ...
            MessagingCenter.Subscribe<HealthCenterProviderViewModel, HealthCenter>(this, "healthCenter", (sender, healthCenter) =>
            {
                ...
                _viewModel.OnHealthCenterId(healthCenter.id);
            });
        }
